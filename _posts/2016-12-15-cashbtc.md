...
key pair $$(pub_A, pr_A)$$, and Bob computes a new keypair $$(pub_B, pr_B)$$.

|-------+----+-----|
| Alice |    | Bob |
|:-----:|:--:|:---:|
| Computes $$TX_0: 1BTC \rightarrow (2of2 \{pub_A, pub_B\})$$ | | |
| Sends $$TX_0:TXID$$ | $$\Longrightarrow$$ | Computes and signs $$TX_0$$ locked refund |
| | $$\Longleftarrow$$ | Sends $$TX_0$$ locked refund |
| Announces $$TX_0$$ | | |
...
| | | Announce $$TX_1$$ |
| | **Bob defaults** | |
| Signs and announces $$TX_0$$ refund | | | 
